...
class G05A_PointsAndLines(SafeScene):
    def construct(self):
        ...
        # ไม่พอ) ตรวจด้วยเลขจริงแล้วว่าทิศ UR (45° เป๊ะ) ให้ผลลัพธ์สะอาดที่สุด --
        # bbox ของป้ายเคลียร์ทั้ง loc, l_AQ, n_line, a_v2 เอง, ra2, และป้าย Q/AQ
        # ข้างเคียงทั้งหมด (ตรวจทีละตัวด้วยจุดจริงบนเส้น ไม่ใช่แค่ประมาณ)
        t_v2 = MathTex("v_{Q_2}", font_size=26, color=C_VQ2).next_to(a_v2.get_center(), UR, buff=0.10)
