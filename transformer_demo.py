...
def make_transformer_rig(center=np.array([-3.3, -0.35, 0]), n1=5, n2=10):
    """
    Builds a physically realistic 2D transformer with a closed laminated iron core loop
    and continuous winding paths wrapped around the core limbs.
    """
    cx, cy, _ = center
...
class TransformerPrimary(SafeScene):
    ...
    def construct(self):
        ...
        n1_tag = Text("N1 = 5 รอบ", font_size=21, color=CURRENT).move_to([lx, -2.7, 0])
