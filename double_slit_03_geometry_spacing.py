...
Scenes:
  - DS05_GeometryDerivation (Target: 80-110s, Planned: ~92s)
  - DS06_SmallAngleSpacing (Target: 70-95s, Planned: ~78s)
"""
...
class DS05_GeometryDerivation(SafeScene):
    """
    Beat 5: Geometry Derivation (Delta r approx d sin theta) (~92s)
    ...
    Micro-beats:
      ...
      3. Geometric angle chain proving triangle apex angle is theta (22s)
      4. Constructive condition: whole wavelengths m lambda (16s)
      5. Destructive condition: half wavelength remainder (16s)
    """
    def construct(self):
        ...
        # 1. Slit Plane Setup (Micro-beat 1: ~18s)
        s_x = -3.0
        d_val = 2.4
        ...
        # 3. Prove Apex Angle is theta (Micro-beat 3: ~22s)
        ...
        # 4 & 5. Conditions for Bright and Dark Fringes (Micro-beats 4 & 5: ~32s)
...
class DS06_SmallAngleSpacing(SafeScene):
    """
    Beat 6: Small-Angle Approximation & Fringe Spacing (~78s)
    Locked Front-on view of screen with intensity plot.
    Micro-beats:
      1. Screen view & fringe orders m (16s)
      2. Small-angle approximation sin(theta) approx tan(theta) approx y/L (18s)
      3. Named-step derivation of y_m and constant Delta y (20s)
      4. Screen dimension brace aligned with intensity peaks (24s)
    """
    def construct(self):
        ...
        # 1. Screen Representation with Stripes (Micro-beat 1: ~16s)
        ...
        # 2 & 3. Mathematical Derivation Panel (Micro-beats 2 & 3: ~38s)
        ...
        self.play(Write(step3), Write(step4), run_time=2.5)
        self.wait(3.5)

        # 4. Exact vs Approximate Laws (Micro-beat 4: ~24s)
